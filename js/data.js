    ...
    scenarii:[
        ...
        { id:'factorio1', label:'scenario_factorio1', desc:'scenarioDesc_factorio1', ready:false, data:{
            ...
            elems:[
                ...
                //---                
                {	id:'techAutomation1',	    type:'tech',	    label:'techAutomation1', desc:'techAutomation1Desc', costs:[{ id:'itemRedPack', count:10 }] },
                {	id:'techSteel',	            type:'tech',	    label:'techSteel', desc:'techSteelDesc', costs:[{ id:'itemRedPack', count:50 }] },
                {	id:'techGreen',	            type:'tech',	    label:'techGreen', desc:'techGreenDesc', costs:[{ id:'itemRedPack', count:75 }] },
                {	id:'techAutomation2',	    type:'tech',	    reqs:[{ id:'techGreen', count:1 },{ id:'techSteel', count:1 }], label:'techAutomation2', desc:'techAutomation2Desc', costs:[{ id:'itemRedPack', count:40 },{ id:'itemGreenPack', count:40 }] },
                {	id:'techMaterial1',	        type:'tech',	    reqs:[{ id:'techGreen', count:1 },{ id:'techSteel', count:1 }], label:'techMaterial1', desc:'techMaterial1Desc', costs:[{ id:'itemRedPack', count:75 },{ id:'itemGreenPack', count:75 }] },
                {	id:'techEngine1',	        type:'tech',	    reqs:[{ id:'techGreen', count:1 },{ id:'techSteel', count:1 }], label:'techEngine1', desc:'techEngine1Desc', costs:[{ id:'itemRedPack', count:100 },{ id:'itemGreenPack', count:100 }] },
                {	id:'techFluid',	            type:'tech',	    reqs:[{ id:'techAutomation2', count:1 },{ id:'techEngine1', count:1 }], label:'techFluid', desc:'techFluidDesc', costs:[{ id:'itemRedPack', count:50 },{ id:'itemGreenPack', count:50 }] },
                {	id:'techOil1',	            type:'tech',	    reqs:[{ id:'techFluid', count:1 }], label:'techOil1', desc:'techOil1Desc', costs:[{ id:'itemRedPack', count:100 },{ id:'itemGreenPack', count:100 }] },
                {	id:'techSulfur',	        type:'tech',	    reqs:[{ id:'techOil1', count:1 }], label:'techSulfur', desc:'techSulfurDesc', costs:[{ id:'itemRedPack', count:150 },{ id:'itemGreenPack', count:150 }] },
                {	id:'techBattery',	        type:'tech',	    reqs:[{ id:'techSulfur', count:1 }], label:'techBattery', desc:'techBatteryDesc', costs:[{ id:'itemRedPack', count:150 },{ id:'itemGreenPack', count:150 }] },
                {	id:'techAccumulator',	    type:'tech',	    reqs:[{ id:'techBattery', count:1 }], label:'techAccumulator', desc:'techAccumulatorDesc', costs:[{ id:'itemRedPack', count:150 },{ id:'itemGreenPack', count:150 }] },
                {	id:'techPlastic',	        type:'tech',	    reqs:[{ id:'techOil1', count:1 }], label:'techPlastic', desc:'techPlasticDesc', costs:[{ id:'itemRedPack', count:200 },{ id:'itemGreenPack', count:200 }] },
                {	id:'techConcrete',	        type:'tech',	    reqs:[{ id:'techAutomation2', count:1 }], label:'techConcrete', desc:'techConcreteDesc', costs:[{ id:'itemRedPack', count:250 },{ id:'itemGreenPack', count:250 }] },
                {	id:'techBlue',	            type:'tech',	    reqs:[{ id:'techPlastic', count:1 },{ id:'techSulfur', count:1 }], label:'techBlue', desc:'techBlueDesc', costs:[{ id:'itemRedPack', count:75 },{ id:'itemGreenPack', count:75 }] },
                {	id:'techOil2',	            type:'tech',	    reqs:[{ id:'techBlue', count:1 }], label:'techOil2', desc:'techOil2Desc', costs:[{ id:'itemRedPack', count:75 },{ id:'itemGreenPack', count:75 },{ id:'itemBluePack', count:75 }] },
                {	id:'techLubricant',	        type:'tech',	    reqs:[{ id:'techOil2', count:1 }], label:'techLubricant', desc:'techLubricantDesc', costs:[{ id:'itemRedPack', count:50 },{ id:'itemGreenPack', count:50 },{ id:'itemBluePack', count:50 }] },
                {	id:'techEngine2',	        type:'tech',	    reqs:[{ id:'techLubricant', count:1 }], label:'techEngine2', desc:'techEngine2Desc', costs:[{ id:'itemRedPack', count:50 },{ id:'itemGreenPack', count:50 },{ id:'itemBluePack', count:50 }] },
                {	id:'techUranium',	        type:'tech',	    reqs:[{ id:'techBlue', count:1 },{ id:'techConcrete', count:1 }], label:'techUranium', desc:'techUraniumDesc', costs:[{ id:'itemRedPack', count:200 },{ id:'itemGreenPack', count:200 },{ id:'itemBluePack', count:200 }] },
                {	id:'techMaterial2',	        type:'tech',	    reqs:[{ id:'techBlue', count:1 }], label:'techMaterial2', desc:'techMaterial2Desc', costs:[{ id:'itemRedPack', count:250 },{ id:'itemGreenPack', count:250 },{ id:'itemBluePack', count:250 }] },
                {	id:'techElectronics3',	    type:'tech',	    reqs:[{ id:'techBlue', count:1 }], label:'techElectronics3', desc:'techElectronics3Desc', costs:[{ id:'itemRedPack', count:300 },{ id:'itemGreenPack', count:300 },{ id:'itemBluePack', count:300 }] },
                {	id:'techRocketFuel',	    type:'tech',	    reqs:[{ id:'techOil2', count:1 }], label:'techRocketFuel', desc:'techRocketFuelDesc', costs:[{ id:'itemRedPack', count:300 },{ id:'itemGreenPack', count:300 },{ id:'itemBluePack', count:300 }] },
                {	id:'techNuclear',	        type:'tech',	    reqs:[{ id:'techUranium', count:1 }], label:'techNuclear', desc:'techNuclearDesc', costs:[{ id:'itemRedPack', count:800 },{ id:'itemGreenPack', count:800 },{ id:'itemBluePack', count:800 }] },
                {	id:'techPurple',	        type:'tech',	    reqs:[{ id:'techMaterial2', count:1 }], label:'techPurple', desc:'techPurpleDesc', costs:[{ id:'itemRedPack', count:100 },{ id:'itemGreenPack', count:100 },{ id:'itemBluePack', count:100 }] },
                {	id:'techAutomation3',	    type:'tech',	    reqs:[{ id:'techPurple', count:1 }], label:'techAutomation3', desc:'techAutomation3Desc', costs:[{ id:'itemRedPack', count:150 },{ id:'itemGreenPack', count:150 },{ id:'itemBluePack', count:150 },{ id:'itemPurplePack', count:150 }] },
                {	id:'techYellow',	        type:'tech',	    reqs:[{ id:'techElectronics3', count:1 }], label:'techYellow', desc:'techYellowDesc', costs:[{ id:'itemRedPack', count:100 },{ id:'itemGreenPack', count:100 },{ id:'itemBluePack', count:100 }] },
                {	id:'techArmor',	            type:'tech',	    reqs:[{ id:'techElectronics3', count:1 },{ id:'techEngine2', count:1 }], label:'techArmor', desc:'techArmorDesc', costs:[{ id:'itemRedPack', count:400 },{ id:'itemGreenPack', count:400 },{ id:'itemBluePack', count:400 },{ id:'itemPurplePack', count:400 },{ id:'itemYellowPack', count:400 }] },
                {	id:'techRocket',	        type:'tech',	    reqs:[{ id:'techConcrete', count:1 },{ id:'techRocketFuel', count:1 }], label:'techRocket', desc:'techRocketDesc', costs:[{ id:'itemRedPack', count:1e3 },{ id:'itemGreenPack', count:1e3 },{ id:'itemBluePack', count:1e3 },{ id:'itemPurplePack', count:1e3 },{ id:'itemYellowPack', count:1e3 }] },
                {	id:'techSpace',	            type:'tech',	    reqs:[{ id:'techRocket', count:1 }], label:'techSpace', desc:'techSpaceDesc', costs:[{ id:'itemRedPack', count:2e3 },{ id:'itemGreenPack', count:2e3 },{ id:'itemBluePack', count:2e3 },{ id:'itemPurplePack', count:2e3 },{ id:'itemYellowPack', count:2e3 }] },
                //---
