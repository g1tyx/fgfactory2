    ...
    scenarii:[
        ...
        { id:'factorio1', label:'scenario_factorio1', desc:'scenarioDesc_factorio1', ready:true, data:{
            ...
            elems:[
                ...
                //---
                {	id:'storerChest',	        type:'storer',	    label:'storerChest', img:'img/storers/Chest.png', storage:{ base:50 }, manualId:'manualChest', lines:[ 'lineChest1', 'lineChest2', 'lineChest3' ] },
                ...
                //---
                {	id:'storerBarrel',          type:'storer',	    reqs:[{ id:'techFluid', count:1 }], label:'storerBarrel', img:'img/storers/Barrel.png', storage:{ base:10 }, manualId:'manualBarrel', lines:[ 'lineBarrel1', 'lineBarrel2', 'lineBarrel3' ] },
                ...
                //---
                {	id:'storerTank',            type:'storer',	    reqs:[{ id:'techFluid', count:1 }], label:'storerTank', img:'img/storers/Tank.png', storage:{ base:50 }, manualId:'manualTank', lines:[ 'lineTank1', 'lineTank2', 'lineTank3' ] },
                ...
                //---
                {	id:'storerAccumulator',     type:'storer',	    reqs:[{ id:'techAccumulator', count:1 }], label:'storerAccumulator', img:'img/storers/Accumulator.png', storage:{ base:50 }, manualId:'manualAccumulator', lines:[ 'lineAccumulator1', 'lineAccumulator2', 'lineAccumulator3' ] },
